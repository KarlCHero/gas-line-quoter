...
export const DEFAULT_CONFIG = {
  ...
  // Locations where PE is permitted. Only EXTERIOR is copper-forced (PE can't be
  // UV-exposed); interior + buried are PE-eligible. PE is only actually used where
